...
@Component({
  ...
  template: `
    <div class="section-container idp-section">
      <h2 class="section-title">{{ title }}</h2>
      <p class="section-description">Individual Development Plan - Ownership and Development</p>
      
      <div class="idp-list" *ngIf="itemsFormArray">
        <div *ngFor="let item of items; let i = index" class="idp-item">
...
export class IdpSectionComponent {
  @Input() title: string = 'Individual Development Plan';
  ...
  get itemsFormArray() {
    return this.formGroup.get('idp') as any;
  }
